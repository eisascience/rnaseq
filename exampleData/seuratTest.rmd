...
data <- list(
  'Set1' = '../exampleData/10XCounts/247-1-CellRanger2/raw_gene_bc_matrices/cellRanger-3204293'
  #'Set2' = '../exampleData/10xCounts/248-1-CellRanger3/raw_feature_bc_matrix'
)
...
seuratObj <- processSeurat1(seuratObj, doCellCycle = T, variableGeneTable = 'variableGenes.txt')
...
saveDimRedux(seuratObj, file = paste(outPrefix, ".DimReduxComps.csv", sep=""))
