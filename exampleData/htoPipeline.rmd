...
if (exists('whitelistFile') && !is.null(whitelistFile) && exists('summaryFile')){
  generateSummaryForExpectedBarcodes(dt, whitelistFile = whitelistFile, outputFile = summaryFile)
}
