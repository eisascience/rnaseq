...
QLresultTop <- generateEdgeRSummary(y_QL, qlf2, 'ql', meta)
...
QLMresultTop <- generateEdgeRSummary(y_QLM, lrt, 'qlm', meta)
...
#run_WGCNA_top_5000(y_QL, 'wgcna.txt', as.integer(meta$GroupCol), meta$GroupCol)
